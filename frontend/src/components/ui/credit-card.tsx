...
export type CreditCardHintProps = HTMLAttributes<HTMLParagraphElement>;

export const CreditCardHint = ({ className, ...props }: CreditCardHintProps) => (
  <p
    className={cn('text-[10px] text-muted-foreground text-center mt-1.5', className)}
    {...props}
  >
    Click to flip
  </p>
